source set_env.sh
python pipeline.py \
    --des "IKEA Attack (chunked HealthCareMagic)" \
    --dataset "HealthCareMagicChunk" \
    --rag "TextRAG" \
    --attack "IKEA" \
    --defense "None" \
    --seed 42 \
